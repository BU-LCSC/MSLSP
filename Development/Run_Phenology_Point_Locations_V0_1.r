...
outDir <- paste0(outFolder,tile,'_V0vsV1/')
...
for (i in 1:length(theTable)) {
    ...
    for (y in 1:length(yrsToPlot)) {
      ...
      png(output_name,res = 600,width = 6,height = 4.5,units = "in",pointsize = 8)
      par(fig=c(0.02,.98,.5,.98),mai=c(0.33,0.33,.3,.1),mgp=c(1.5,0.2,0))
