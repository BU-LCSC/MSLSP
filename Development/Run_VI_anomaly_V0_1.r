...
# png(filename='filt_map_rmse.png',width=13,height=6.2,units='in',res=300)

par(fig=c(0,0.5,0,1),oma=c(0.5,0.5,0.5,0.5),mar=c(0.5,0.5,0.5,0.5),mgp=c(3.5,1,0))

plot(pixTab$original_VI,ylim=c(-.1,1))
